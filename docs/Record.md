...
`func NewRecord(type_ string, host string, ipv4 string, ipv6 string, canonicalName string, priority int32, exchange string, value string, nameserver string, mName string, rName string, serial int32, refresh int32, retry int32, expire int32, minimum int32, weight int32, port int32, target string, pointer string, flags int32, tag string, ) *Record`
